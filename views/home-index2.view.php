				...
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li><a href="https://www.facebook.com/dire.classic.corp" target="_blank">Facebook</a></li>
<!-- 							<li><a href="./products.html">Woman</a>					
			...
			<section class="header_text">
				Chuyên cung cấp sản phẩm thuần thiên nhiên, mang lại cho bạn làn da sáng đẹp, mịn màng & cơ thể khỏe mạnh, cân đối. 
				<br/>Mục tiêu mang lại lợi ích cho cộng đồng người Việt Nam.
			</section>
