...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="themes/css/chuong.css">
				...
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li><a href="https://www.facebook.com/pg/dire.classic.ltd/shop/?ref=page_internal" target="_blank">Facebook</a></li>
												...
												<?php foreach($products as $product): ?>
													<li class="span3">
														<div class="product-box">
															...
															<p><a href="product_detail.html"><img src="themes/images/home/<?= randomImages($product->img); ?>" alt="" /></a></p>
...
<!-- 												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.html"><img src="themes/images/home/lotion_dua_tinh_khiet_01.jpg" alt="" /></a></p>
														<a href="product_detail.html" class="title">Lotion dừa tinh khiết</a><br/>
														<a href="products.html" class="category">Commodo consequat</a>
							...
							<div class="span4">
								<div class="service">
									<div class="responsive">	
										...
										<p>Chuyên cung cấp sản phẩm thuần thiên nhiên, mang lại cho bạn làn da sáng đẹp, mịn màng & cơ thể khỏe mạnh, cân đối.<br><br></p>									
									</div>
								</div>
							</div>
							<div class="span4">	
								<div class="service">
									<div class="support">	
										...
										<p>Hotline đặt hàng : 0906864648 (Zalo, Mesenger, Viber).<br>Chăm sóc KH : 0931076107 (Zalo, Mesenger, Viber).<br>Email : direclassic2016@yahoo.com.</p>
									</div>
								</div>
							</div>
							<div class="span4">
								<div class="service">
									<div class="customize">			
										...
										<h4><strong>Giao Hàng</strong></h4>
										<p>Trên 150k Free ship khu vực TPHCM & Cà Mau.<br />Trên 350k Free ship toàn quốc.<br><br></p>
									</div>
								</div>
							</div>	
						</div>		
